...
# ╔═╡ 94ae25e4-9e30-11ec-27ad-5392ebe4e90e
using ImageMagick

# ╔═╡ 03c08ba2-45d8-4bd7-9fff-fab8b28e101a
using FileIO

# ╔═╡ 1d60f387-6f66-40aa-bb52-c864401c5533
using Images

# ╔═╡ b41fc013-e298-43c3-b986-f7228ce17c6e
img = load("透明底logo.png")

# ╔═╡ 5dfdd800-e9fc-4043-a4e4-c55ac278d476
x = load("透明底[中文].png")[500:600, 500:600][end, end]

# ╔═╡ e77e3159-0e8f-4595-946f-2c2acf80d6f4
x.alpha

# ╔═╡ 15809634-dc04-4e5e-9dc7-1358dab06b00
img_gray = map(img) do x
	if x === RGBA(0,0,0,0)
		x
	elseif x === RGBA(1,1,1,1)
		RGBA(0,0,0,0)
	else
...
# ╔═╡ 2d92f77e-7117-4a73-a178-d33b516455f3
save("透明底_灰色_logo.png", img_gray)
